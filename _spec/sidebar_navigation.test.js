...
describe('sidebarNavigation', () => {
  ...
  it('removes active class from other links', () => {
    ...
    link.click()
    expect(document.querySelector("a[data-target='bar']").classList).not.toContain('active')
  })

  it('adds an active class to the clicked link', () => {
    var link = document.querySelector("a[data-target='foo']")
    link.click()
    expect(document.querySelector("a[data-target='foo']").classList).toContain('active')
  })
